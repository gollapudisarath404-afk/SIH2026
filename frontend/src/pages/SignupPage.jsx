    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-teal-50/40 flex flex-col justify-between p-6">
      ...
      <div className="max-w-md w-full mx-auto my-8">
        <div className="rounded-3xl bg-white p-8 border border-slate-200/80 shadow-card space-y-6">
          <div>
            <h1 className="text-2xl font-extrabold text-navy-900 tracking-tight">{t("signup")}</h1>
            <p className="text-xs text-slate-500 mt-1">Create your citizen profile to unlock personalized benefits</p>
          </div>
          ...
          <div className="text-center pt-2">
            <p className="text-xs text-slate-500">
              ...
              <Link className="font-bold text-navy-900 hover:underline" to="/login">
                {t("login")}
              </Link>
            </p>
          </div>
